...
;FamiTone settings, you probably would want to move it outside of this file
.segment "CODE"

FT_BASE_ADR		= famitone_memory ;$0700	;page in RAM, should be $xx00
FT_TEMP			= ft_temp ; $00	;7 bytes in zeropage
...
.define PRIORITY_0 #FT_SFX_CH0
.define PRIORITY_1 #FT_SFX_CH1
.define PRIORITY_2 #FT_SFX_CH2
.define PRIORITY_3 #FT_SFX_CH3
